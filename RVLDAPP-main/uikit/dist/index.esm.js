...
var Icon$_ = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: "90", height: "90", href: '/logo1.png' })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, style: { color: "white" }, endIcon: expanded ? React.createElement(Icon$1x, { color: "text" }) : React.createElement(Icon$1A, { color: "text" }) }, children));
};
    ...
    return (React.createElement(StyledBalanceInput, __assign({ isWarning: isWarning }, props),
        React.createElement(Flex, { justifyContent: "flex-end" },
            React.createElement(Box, null,
                ...
                currencyValue && (React.createElement(Text, { fontSize: "12px", textAlign: "right", color: "text" }, currencyValue))),
            switchEditingUnits && (React.createElement(Flex, { alignItems: "center", pl: "12px" },
                React.createElement(SwitchUnitsButton, { scale: "sm", variant: "text", onClick: switchEditingUnits },
                    React.createElement(Icon$H, { color: "textSubtle" })))))));
};
...
var InactiveButton = styled(Button)(templateObject_1$Z || (templateObject_1$Z = __makeTemplateObject(["\n  background-color: transparent;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"], ["\n  background-color: transparent;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"])), function (_a) {
    var theme = _a.theme, variant = _a.variant;
    return (variant === variants$6.PRIMARY ? theme.colors.primary : theme.colors.text);
});
...
var StyledCard = styled.div(templateObject_3$c || (templateObject_3$c = __makeTemplateObject(["\n  background: ", ";\n  border-radius: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n\n  padding: 1px 1px 3px 1px;\n\n  ", "\n"], ["\n  background: ", ";\n  border-radius: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n\n  padding: 1px 1px 3px 1px;\n\n  ", "\n"])), getBorderColor, function (_a) {
    ...
    return theme.colors[isDisabled ? "secondary" : "primary"];
}, function (_a) {
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$12, { color: props.color ? props.color : "text", ml: "4px" })));
};
...
styled(Icon$l)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#d3d8d8", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#0D0D2B", textDisabled: "#0D0D2B", textSubtle: "#0D0D2B", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#16164e", backgroundDisabled: "#d3d8d8", backgroundAlt: "#0D0D2B", cardBorder: "#FFFFFF", contrast: "#FFFFFF", dropdown: "#16164e", dropdownDeep: "#16164e", invertedContrast: "#161044", input: "#e0e2e4", inputSecondary: "#aaa3b9", primaryDark: "#F9F9F9", tertiary: "#111143", text: "#0D0D2B", textDisabled: "#2f2f43", textSubtle: "#fbfcfc", disabled: "#524B63", gradients: {
...
var Icon$2 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 640 512", width: "24px", height: "24px" }, props),
        React.createElement("path", { d: "M524.531,69.836a1.5,1.5,0,0,0-.764-.7A485.065,485.065,0,0,0,404.081,32.03a1.816,1.816,0,0,0-1.923.91,337.461,337.461,0,0,0-14.9,30.6,447.848,447.848,0,0,0-134.426,0,309.541,309.541,0,0,0-15.135-30.6,1.89,1.89,0,0,0-1.924-.91A483.689,483.689,0,0,0,116.085,69.137a1.712,1.712,0,0,0-.788.676C39.068,183.651,18.186,294.69,28.43,404.354a2.016,2.016,0,0,0,.765,1.375A487.666,487.666,0,0,0,176.02,479.918a1.9,1.9,0,0,0,2.063-.676A348.2,348.2,0,0,0,208.12,430.4a1.86,1.86,0,0,0-1.019-2.588,321.173,321.173,0,0,1-45.868-21.853,1.885,1.885,0,0,1-.185-3.126c3.082-2.309,6.166-4.711,9.109-7.137a1.819,1.819,0,0,1,1.9-.256c96.229,43.917,200.41,43.917,295.5,0a1.812,1.812,0,0,1,1.924.233c2.944,2.426,6.027,4.851,9.132,7.16a1.884,1.884,0,0,1-.162,3.126,301.407,301.407,0,0,1-45.89,21.83,1.875,1.875,0,0,0-1,2.611,391.055,391.055,0,0,0,30.014,48.815,1.864,1.864,0,0,0,2.063.7A486.048,486.048,0,0,0,610.7,405.729a1.882,1.882,0,0,0,.765-1.352C623.729,277.594,590.933,167.465,524.531,69.836ZM222.491,337.58c-28.972,0-52.844-26.587-52.844-59.239S193.056,219.1,222.491,219.1c29.665,0,53.306,26.82,52.843,59.239C275.334,310.993,251.924,337.58,222.491,337.58Zm195.38,0c-28.971,0-52.843-26.587-52.843-59.239S388.437,219.1,417.871,219.1c29.667,0,53.307,26.82,52.844,59.239C470.715,310.993,447.538,337.58,417.871,337.58Z" })));
};

var Icon$1 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 448 512", width: "24px", height: "24px" }, props),
...
var Icon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512 512", width: "24px", height: "24px" }, props),
        React.createElement("path", { d: "M440.3 203.5c-15 0-28.2 6.2-37.9 15.9-35.7-24.7-83.8-40.6-137.1-42.3L293 52.3l88.2 19.8c0 21.6 17.6 39.2 39.2 39.2 22 0 39.7-18.1 39.7-39.7s-17.6-39.7-39.7-39.7c-15.4 0-28.7 9.3-35.3 22l-97.4-21.6c-4.9-1.3-9.7 2.2-11 7.1L246.3 177c-52.9 2.2-100.5 18.1-136.3 42.8-9.7-10.1-23.4-16.3-38.4-16.3-55.6 0-73.8 74.6-22.9 100.1-1.8 7.9-2.6 16.3-2.6 24.7 0 83.8 94.4 151.7 210.3 151.7 116.4 0 210.8-67.9 210.8-151.7 0-8.4-.9-17.2-3.1-25.1 49.9-25.6 31.5-99.7-23.8-99.7zM129.4 308.9c0-22 17.6-39.7 39.7-39.7 21.6 0 39.2 17.6 39.2 39.7 0 21.6-17.6 39.2-39.2 39.2-22 .1-39.7-17.6-39.7-39.2zm214.3 93.5c-36.4 36.4-139.1 36.4-175.5 0-4-3.5-4-9.7 0-13.7 3.5-3.5 9.7-3.5 13.2 0 27.8 28.5 120 29 149 0 3.5-3.5 9.7-3.5 13.2 0 4.1 4 4.1 10.2.1 13.7zm-.8-54.2c-21.6 0-39.2-17.6-39.2-39.2 0-22 17.6-39.7 39.2-39.7 22 0 39.7 17.6 39.7 39.7-.1 21.5-17.7 39.2-39.7 39.2z" })));
};
...
var Logo = function (_a) {
    ...
    var certikImg = (React.createElement(React.Fragment, null,
        React.createElement(Svg, { viewBox: "0 0 75 65", width: "55px", className: "mobile-certik" },
            React.createElement("image", { width: "70", height: "65", href: '/images/certik_mobile.png' })),
        React.createElement(Svg, { viewBox: "0 0 512 65", width: "300px", className: "desktop-certik" },
            React.createElement("image", { width: "450", height: "65", href: '/images/certik.png' }))));
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "14px" }, isPushed ? (React.createElement(Icon$g, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$h, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Lovepot home page" },
            innerLogo,
            certikImg)) : (React.createElement(StyledLink, { to: href, "aria-label": "Lovepot home page" },
            innerLogo,
            certikImg))));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink$1, { href: "https://poocoin.app/tokens/0x4666E77FA1A7F6749E48B533EF500587B094F61c", target: "_blank" },
...
var RvlPrice = function (_a) {
    var rvlPriceUsd = _a.rvlPriceUsd;
    return rvlPriceUsd ? (React.createElement(PriceLink, { href: "https://poocoin.app/tokens/0x7EaeE60040135F20f508A393ca400dEd339d654e", target: "_blank" },
        React.createElement(Icon$_, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + rvlPriceUsd.toFixed(7)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var RvlPrice$1 = React.memo(RvlPrice);
var templateObject_1$c;
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav; _a.toggleTheme; _a.isDark; var cakePriceUsd = _a.cakePriceUsd, rvlPriceUsd = _a.rvlPriceUsd; _a.currentLang; _a.langs; _a.setLang;
    if (!isPushed) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            ...
            React.createElement(RvlPrice$1, { rvlPriceUsd: rvlPriceUsd }),
...
var Menu$1 = function (_a) {
    var _b;
    var userMenu = _a.userMenu; _a.globalMenu; var isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, rvlPriceUsd = _a.rvlPriceUsd, links = _a.links, children = _a.children;
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, { alignItems: "center" }, userMenu)),
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isSmallerScreen, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, rvlPriceUsd: rvlPriceUsd, pushNav: setIsPushed, links: links }),
...
export { Icon$1W as AddIcon, Alert, Icon$1V as ArrowBackIcon, Icon$1U as ArrowDownIcon, Icon$1T as ArrowDropDownIcon, Icon$1S as ArrowDropUpIcon, Icon$1R as ArrowFirstIcon, Icon$1Q as ArrowForwardIcon, Icon$1P as ArrowLastIcon, Icon$1O as ArrowUpIcon, Icon$1N as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, Icon$1L as BinanceChainIcon, Icon$1M as BinanceIcon, Icon$1Y as BlockIcon, Icon$1K as BnbUsdtPairTokenIcon, Box, Breadcrumbs, Icon$1J as BunnyCardsIcon, Icon$1I as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, Icon$1F as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1G as CardViewIcon, Icon$1H as Cards, GridLayout as CardsLayout, Icon$1D as ChartIcon, Checkbox, Icon$1B as CheckmarkCircleFillIcon, Icon$1_ as CheckmarkCircleIcon, Icon$1C as CheckmarkIcon, Icon$1A as ChevronDownIcon, Icon$1z as ChevronLeftIcon, Icon$1y as ChevronRightIcon, Icon$1x as ChevronUpIcon, Icon$1E as CircleOutlineIcon, Icon$1w as CloseIcon, Icon$1v as CogIcon, Icon$1u as Coin98Icon, Icon$1t as CommunityIcon, ConnectorNames, Icon$1s as CopyIcon, Icon$1r as CrownIcon, Icon$1q as CurrencyIcon, Dropdown, Icon$1p as EllipsisIcon, Icon$1Z as ErrorIcon, ExpandableButton, ExpandableLabel, FallingBunnies, Flex, Grid, Heading, Icon$1o as HelpIcon, Icon$1n as HistoryIcon, IconButton, Image, Icon$1X as InfoIcon, Input$1 as Input, InputGroup, Icon$1l as LanguageCurrencyIcon, Icon$1m as LanguageIcon, Icon$1k as LaurelLeftIcon, Icon$1j as LaurelRightIcon, Link, LinkExternal, Icon$1i as ListViewIcon, Icon$1h as LoginIcon, Icon$1g as LogoIcon, Icon$1f as LogoRoundIcon, Icon$1d as LogoutIcon, Icon$1e as MathWalletIcon, Icon$1c as MedalBronzeIcon, Icon$1b as MedalGoldIcon, Icon$1a as MedalPurpleIcon, Icon$19 as MedalSilverIcon, Icon$18 as MedalTealIcon, Menu$1 as Menu, Message, Icon$17 as MetamaskIcon, Icon$16 as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$15 as MoreHorizontalIcon, Icon$14 as MoreVerticalIcon, Icon$13 as NoProfileAvatarIcon, NotificationDot, Icon$12 as OpenNewIcon, Overlay, Icon$$ as PancakeRoundIcon, PancakeToggle, Icon$11 as PancakesIcon, Icon$10 as PencilIcon, Icon$Y as PlayCircleOutlineIcon, Icon$Z as PocketWatchIcon, Icon$X as PredictionsIcon, Icon$R as PresentCheckIcon, Icon$P as PresentNoneIcon, Icon$Q as PresentWonIcon, Icon$W as PrizeIcon, ProfileAvatar, Progress, Icon$S as ProgressBunny, Icon$V as ProposalIcon, Radio, Icon$O as RefreshIcon, Icon$U as RemoveIcon, ResetCSS, Icon$_ as RivalRoundIcon, Icon$N as SafePalIcon, Icon$M as SearchIcon, Skeleton, Slider, Icon$L as SmallDotIcon, Spinner, Icon$K as StarFillIcon, Icon$J as StarLineIcon, Step, Stepper, SubMenu, SubMenuItem, Svg, Icon$I as SwapIcon, Icon$H as SwapVertIcon, Icon$G as SyncAltIcon, Tab, ButtonMenu as TabMenu, Table, Tag, Td, Icon$F as TeamPlayerIcon, Icon$E as TestnetIcon, Text, Th, Icon$D as Ticket, Icon$C as TicketFillIcon, Icon$B as TicketRound, Icon$A as TimerIcon, ToastContainer, Toggle, TokenImage, TokenPairImage, Icon$z as TokenPocketIcon, TooltipText, Icon$y as TrophyGoldIcon, Icon$x as TrustWalletIcon, Icon$w as TuneIcon, UserMenu, UserMenuDivider, UserMenuItem, Icon$T as VerifiedIcon, Icon$v as VisibilityOff, Icon$u as VisibilityOn, Icon$t as VolumeOffIcon, Icon$s as VolumeUpIcon, Icon$r as VoteIcon, Icon$m as WaitIcon, Icon$p as WalletConnectIcon, Icon$n as WalletFilledIcon, Icon$o as WalletIcon, Icon$q as WarningIcon, variants$5 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useTooltip, useWalletModal };
