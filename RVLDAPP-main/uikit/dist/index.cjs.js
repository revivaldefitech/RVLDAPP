...
var Icon$_ = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: "90", height: "90", href: '/logo1.png' })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React__default['default'].createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, style: { color: "white" }, endIcon: expanded ? React__default['default'].createElement(Icon$1x, { color: "text" }) : React__default['default'].createElement(Icon$1A, { color: "text" }) }, children));
};
    ...
    return (React__default['default'].createElement(StyledBalanceInput, __assign({ isWarning: isWarning }, props),
        React__default['default'].createElement(Flex, { justifyContent: "flex-end" },
            React__default['default'].createElement(Box, null,
                ...
                currencyValue && (React__default['default'].createElement(Text, { fontSize: "12px", textAlign: "right", color: "text" }, currencyValue))),
...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$12, { color: props.color ? props.color : "text", ml: "4px" })));
};
...
styled__default['default'](Icon$l)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var Icon$2 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 640 512", width: "24px", height: "24px" }, props),
        React__default['default'].createElement("path", { d: "M524.531,69.836a1.5,1.5,0,0,0-.764-.7A485.065,485.065,0,0,0,404.081,32.03a1.816,1.816,0,0,0-1.923.91,337.461,337.461,0,0,0-14.9,30.6,447.848,447.848,0,0,0-134.426,0,309.541,309.541,0,0,0-15.135-30.6,1.89,1.89,0,0,0-1.924-.91A483.689,483.689,0,0,0,116.085,69.137a1.712,1.712,0,0,0-.788.676C39.068,183.651,18.186,294.69,28.43,404.354a2.016,2.016,0,0,0,.765,1.375A487.666,487.666,0,0,0,176.02,479.918a1.9,1.9,0,0,0,2.063-.676A348.2,348.2,0,0,0,208.12,430.4a1.86,1.86,0,0,0-1.019-2.588,321.173,321.173,0,0,1-45.868-21.853,1.885,1.885,0,0,1-.185-3.126c3.082-2.309,6.166-4.711,9.109-7.137a1.819,1.819,0,0,1,1.9-.256c96.229,43.917,200.41,43.917,295.5,0a1.812,1.812,0,0,1,1.924.233c2.944,2.426,6.027,4.851,9.132,7.16a1.884,1.884,0,0,1-.162,3.126,301.407,301.407,0,0,1-45.89,21.83,1.875,1.875,0,0,0-1,2.611,391.055,391.055,0,0,0,30.014,48.815,1.864,1.864,0,0,0,2.063.7A486.048,486.048,0,0,0,610.7,405.729a1.882,1.882,0,0,0,.765-1.352C623.729,277.594,590.933,167.465,524.531,69.836ZM222.491,337.58c-28.972,0-52.844-26.587-52.844-59.239S193.056,219.1,222.491,219.1c29.665,0,53.306,26.82,52.843,59.239C275.334,310.993,251.924,337.58,222.491,337.58Zm195.38,0c-28.971,0-52.843-26.587-52.843-59.239S388.437,219.1,417.871,219.1c29.667,0,53.307,26.82,52.844,59.239C470.715,310.993,447.538,337.58,417.871,337.58Z" })));
};

var Icon$1 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 448 512", width: "24px", height: "24px" }, props),
...
var Icon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 512 512", width: "24px", height: "24px" }, props),
        React__default['default'].createElement("path", { d: "M440.3 203.5c-15 0-28.2 6.2-37.9 15.9-35.7-24.7-83.8-40.6-137.1-42.3L293 52.3l88.2 19.8c0 21.6 17.6 39.2 39.2 39.2 22 0 39.7-18.1 39.7-39.7s-17.6-39.7-39.7-39.7c-15.4 0-28.7 9.3-35.3 22l-97.4-21.6c-4.9-1.3-9.7 2.2-11 7.1L246.3 177c-52.9 2.2-100.5 18.1-136.3 42.8-9.7-10.1-23.4-16.3-38.4-16.3-55.6 0-73.8 74.6-22.9 100.1-1.8 7.9-2.6 16.3-2.6 24.7 0 83.8 94.4 151.7 210.3 151.7 116.4 0 210.8-67.9 210.8-151.7 0-8.4-.9-17.2-3.1-25.1 49.9-25.6 31.5-99.7-23.8-99.7zM129.4 308.9c0-22 17.6-39.7 39.7-39.7 21.6 0 39.2 17.6 39.2 39.7 0 21.6-17.6 39.2-39.2 39.2-22 .1-39.7-17.6-39.7-39.2zm214.3 93.5c-36.4 36.4-139.1 36.4-175.5 0-4-3.5-4-9.7 0-13.7 3.5-3.5 9.7-3.5 13.2 0 27.8 28.5 120 29 149 0 3.5-3.5 9.7-3.5 13.2 0 4.1 4 4.1 10.2.1 13.7zm-.8-54.2c-21.6 0-39.2-17.6-39.2-39.2 0-22 17.6-39.7 39.2-39.7 22 0 39.7 17.6 39.7 39.7-.1 21.5-17.7 39.2-39.7 39.2z" })));
};
...
var Logo = function (_a) {
    ...
    var certikImg = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Svg, { viewBox: "0 0 75 65", width: "55px", className: "mobile-certik" },
            React__default['default'].createElement("image", { width: "70", height: "65", href: '/images/certik_mobile.png' })),
        React__default['default'].createElement(Svg, { viewBox: "0 0 512 65", width: "300px", className: "desktop-certik" },
            React__default['default'].createElement("image", { width: "450", height: "65", href: '/images/certik.png' }))));
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "14px" }, isPushed ? (React__default['default'].createElement(Icon$g, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$h, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Lovepot home page" },
            innerLogo,
            certikImg)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Lovepot home page" },
            innerLogo,
            certikImg))));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink$1, { href: "https://poocoin.app/tokens/0x4666E77FA1A7F6749E48B533EF500587B094F61c", target: "_blank" },
...
var RvlPrice = function (_a) {
    ...
    return rvlPriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://poocoin.app/tokens/0x7EaeE60040135F20f508A393ca400dEd339d654e", target: "_blank" },
        React__default['default'].createElement(Icon$_, { width: "24px", mr: "8px" }),
        React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + rvlPriceUsd.toFixed(7)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
var RvlPrice$1 = React__default['default'].memo(RvlPrice);
var templateObject_1$c;
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(SocialEntry, null,
            ...
            React__default['default'].createElement(RvlPrice$1, { rvlPriceUsd: rvlPriceUsd }),
...
var Menu$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isSmallerScreen, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, rvlPriceUsd: rvlPriceUsd, pushNav: setIsPushed, links: links }),
...
exports.ArrowFirstIcon = Icon$1R;
exports.ArrowForwardIcon = Icon$1Q;
exports.ArrowLastIcon = Icon$1P;
...
exports.BinanceChainIcon = Icon$1L;
...
exports.CheckmarkCircleIcon = Icon$1_;
...
exports.RivalRoundIcon = Icon$_;
exports.SafePalIcon = Icon$N;
